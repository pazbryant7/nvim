return {
	...
	keys = {
		...
		{ '<leader>n', function() require('harpoon'):list():next({ ui_nav_wrap = true }) end, desc = 'Harpoon next harpoon' },
		{ '<leader>p', function() require('harpoon'):list():prev({ ui_nav_wrap = true }) end, desc = 'Harpoon previous harpoon' },
